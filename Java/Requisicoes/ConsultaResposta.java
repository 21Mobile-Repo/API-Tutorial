...
public class ConsultaResposta {
    ...
    public void consultaResp(long timestampUnix) throws MalformedURLException, IOException {

        URL url = new URL("https://api.21mobile.com.br/v1/consultmo?date=" + timestampUnix);
